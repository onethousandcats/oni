...
var TypeScriptServerHost = (function (_super) {
    ...
    TypeScriptServerHost.prototype.changeLineInFile = function (file, line, newLineContents) {
        return this._makeTssRequest("change", {
            file: file,
            line: line,
            offset: 1,
            endOffset: 1,
    ...
    TypeScriptServerHost.prototype.findAllReferences = function (file, line, offset) {
        return this._makeTssRequest("references", {
            file: file,
            line: line,
            offset: offset,
        });
